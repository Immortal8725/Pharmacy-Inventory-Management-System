...
Windows:
    Double-click healthfirst_pims.bat
    (This starts dist\healthfirst_pims.jar. To submit a .exe, wrap that JAR
    with Launch4j or jpackage on a Windows PC as yourname_pims.exe.)
